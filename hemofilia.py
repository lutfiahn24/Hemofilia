...
kb_hemofilia = FolKB(map(expr, [
    ...
    'SaudaraKandung(CharlesI,Elizabeth)','SaudaraKandung(Elizabeth,CharlesI)','SaudaraKandung(CatherineI,CharlesII)','SaudaraKandung(CatherineI,JamesII)','SaudaraKandung(JamesII,CharlesII)','SaudaraKandung(JamesII,CatherineI)','SaudaraKandung(CharlesII,JamesII)','SaudaraKandung(CharlesII,CatherineI)',
